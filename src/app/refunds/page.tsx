    ...
    <>
      <div className="max-w-[1200px] mx-auto">
        ...
        <section className="mx-auto max-w-4xl py-10 md:py-18 text-[#D1D5DB]">
          <div className="prose prose-xl prose-invert !max-w-none prose-headings:font-medium prose-a:text-[#AFB0BA] prose-p:text-base prose-ul:text-[#AFB0BA] prose-li:text-[#AFB0BA]">
