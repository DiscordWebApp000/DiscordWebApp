      ...
      <div className="max-w-[1200px] mx-auto px-2">
        ...
        <section className="mx-auto max-w-4xl py-8 md:py-16 px-4">
          <div className="prose prose-lg prose-invert !max-w-none">
            ...
            <h3 className="text-xl md:text-xl lg:text-2xl font-semibold mb-4">Satın Almalar</h3>
            <p className="text-[#D1D5DB] text-base mb-6">
            ...
            <h3 className="text-xl md:text-xl lg:text-2xl font-semibold mb-4">Kullanılabilirlik, Hatalar ve Yanlışlıklar</h3>
            <p className="text-[#D1D5DB] text-base mb-6">
            ...
            <h3 className="text-xl md:text-xl lg:text-2xl font-semibold mb-4">Diğer Web Sitelerine Bağlantılar</h3>
            <p className="text-[#D1D5DB] text-base mb-6">
            ...
            <h3 className="text-xl md:text-xl lg:text-2xl font-semibold mb-4">Fesih</h3>
            <p className="text-[#D1D5DB] text-base mb-6">
            ...
            <h3 className="text-xl md:text-xl lg:text-2xl font-semibold mb-4">Tazminat</h3>
            <p className="text-[#D1D5DB] text-base mb-6">
            ...
            <h3 className="text-xl md:text-xl lg:text-2xl font-semibold mb-4">Sorumluluk Reddi</h3>
            <p className="text-[#D1D5DB] text-base mb-6">
            ...
            <h3 className="text-xl md:text-xl lg:text-2xl font-semibold mb-4">Geçerli Hukuk</h3>
            <p className="text-[#D1D5DB] text-base mb-6">
            ...
            <h3 className="text-xl md:text-xl lg:text-2xl font-semibold mb-4">Değişiklikler</h3>
            <p className="text-[#D1D5DB] text-base mb-6">
