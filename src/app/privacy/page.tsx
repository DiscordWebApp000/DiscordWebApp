  ...
  return (
    ...
    <div className='w-[1200px] mx-auto'>
      ...
      <section className="mx-auto max-w-4xl py-10 md:py-18 text-[#D1D5DB]">
        <div className="prose prose-xl prose-invert !max-w-none prose-headings:font-medium prose-a:text-[#D1D5DB] prose-p:text-[#D1D5DB] prose-ul:text-[#D1D5DB] prose-li:text-[#D1D5DB]" style={{ fontSize: '1.1rem' }}>
